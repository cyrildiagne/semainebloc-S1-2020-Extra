...
let result;
>>>>>>> 1a04ee993b2a24485c763be35a6811890fbe5689
...
async function texturer() {
  ...
  try {
    ...
    const dataUrl = await toDataURL(textureTransferLink);
    return dataUrl;
  } catch (e) {
    console.log(e);
  }
...
=======
  const images = await getImages('cake');
>>>>>>> 1a04ee993b2a24485c763be35a6811890fbe5689
...
=======
  for (let i = 0; i < 10; i++) {
    ...
    const sphere = new THREE.Mesh(geometry, randomMaterial); // Add to scene
>>>>>>> 1a04ee993b2a24485c763be35a6811890fbe5689
